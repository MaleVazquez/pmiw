...
function cargarBotones(pantallaNum) {
  if (pantallaNum === 0) {
    ...
    text("Vazquez Leonela Malena", width / 2, height / 2 - 20);  // Muestra el primer nombre un poco más arriba
    text("Vazquez Leandro Nicolas", width / 2, height / 2 + 20);  // Muestra el segundo nombre un poco más abajo
